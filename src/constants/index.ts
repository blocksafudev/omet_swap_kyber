...
export const STAKE_URL = 'https://metti.blocksafu.com/staking'
...
export const KYBER_NETWORK_TWITTER_URL = 'https://twitter.com/'
...
export const TERM_FILES_PATH = {
  KYBERSWAP_TERMS: '/metti-terms.pdf',
  PRIVACY_POLICY: '/metti-privacy.pdf',
