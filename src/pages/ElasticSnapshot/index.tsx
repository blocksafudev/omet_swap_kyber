...
export default function ElasticSnapshot() {
  ...
  const categoriesDesc = [
    <Trans key={0}>
      Affected Assets taken from Affected Pools by the primary Metti Elastic Exploit (“Primary Exploit”) which commenced
      on November 22, 2023 at 10:54 PM UTC, which Affected Assets have yet to be recovered{' '}
    </Trans>,
    <Trans key={1}>
          ...
          {tab === 'snapshot' && (
            <>
              <Text fontSize={14} color={theme.subText} lineHeight="20px">
                <Trans>
                  You can find the list of your liquidity positions in Metti Elastic pools that were affected by the
                ...
                <Flex padding="48px 16px" justifyContent="center" alignItems="center" flexDirection="column">
                  <Text fontSize="14px" marginBottom="24px" maxWidth="820px">
                    <Trans>
                      ...
                      contact us at <a href="mailto:support@metti.com">support@metti.com</a>
                    </Trans>
                  </Text>
