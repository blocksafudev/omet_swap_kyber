    ...
    <Modal isOpen={isOpen} onDismiss={onDismiss} maxWidth="480px" width="100%">
      <Flex flexDirection="column" padding="20px" bg={theme.background} width="100%" lineHeight={1.5}>
        ...
        <Text fontSize="12px" marginTop="24px" color={theme.subText} textAlign="justify">
          <Trans>
            Metti Elastic Exploit Treasury Grant Program (“Program”) will support Affected Users who have lost Affected
            Assets to the Metti Elastic Exploit. Under the Program, an Affected User who fulfils Eligibility
            Requirements can choose from one of the following options for the Treasury Grants in respect of each
            Affected Address of such Affected User.
          </Trans>
        </Text>
            ...
            {/* <TermAndCondition onClick={() => setIsAcceptTerm(prev => !prev)} style={{ marginTop: '24px' }}>
              ...
              <Text color={theme.subText}>
                ...
                <ExternalLink href={TERM_FILES_PATH.KYBERSWAP_TERMS} onClick={e => e.stopPropagation()}>
                  <Trans>Metti&lsquo;s Terms of Use</Trans>
                </ExternalLink>{' '}
                <Trans>and</Trans>{' '}
