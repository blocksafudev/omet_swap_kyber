    ...
    <>
      ...
      <Flex flexDirection="column">
        ...
        <Text fontSize={14} color={theme.subText} lineHeight={1.5}>
          ...
          To be eligible for Phase 3 of the Metti Grant Program, users must have strictly followed specific processes
          and completed their reports before the Phase 2 deadline. This phase is exclusively available to those who
          fulfilled all requirements within the given timeframe, and <b>is not open for new applications</b> after the
          Phase 2 cutoff. Eligible cases include:
          <ul>
            <li>
          ...
          <Text>
            All users eligible for Phase 3 have been notified of their eligibility directly through the Metti Customer
            Support channel.
          </Text>
        </Text>
        ...
        <Text marginTop="8px" fontSize={14} color={theme.subText} lineHeight="20px">
          <Trans>
            To apply for Metti Treasury Grant, complete your KYC process and select your preferred option before January
            31, 2024 - 14 OTC
          </Trans>
        </Text>
              ...
              >
                <Text fontSize={14} flex={1} lineHeight="20px">
                  {userSelectedOption === 'C' ? (
                    ...
                    <Trans>
                      In case you want to Opt Out (i) from Metti Treasury Grant Program, proceed in actions.
                    </Trans>
                  )}
                </Text>
