    ...
    <Modal isOpen={isOpen} onDismiss={onDismiss} maxWidth="800px" width="100%">
      ...
      >
        ...
        >
          ...
          <Text marginTop="-4px">
            I understand that my participation in the [Metti Elastic Exploit Grant Program] (“Grant Program”) will be
            subject to my completion of KYC screening to the satisfaction of Metti and further subject to terms (“Terms
            of Grant”) to be published by Metti, which Terms of Grant will include terms that require return of all or
            part of any grant to me pursuant to the Grant Program in the event of my full or partial recovery of assets
            taken from me in the Metti Elastic Exploit.
          </Text>
        </Flex>
        ...
        >
          ...
          <Text marginTop="-4px">
            ...
            will be eligible to be considered for or to receive any grant as Metti may decide to extend to me pursuant
