      ...
      ?.send('eth_signTypedData_v4', [
        ...
        JSON.stringify({
          ...
          message: {
            ...
            termsAndConditions:
              phase !== '1'
                ? 'By confirming this transaction, I agree to the Metti Elastic Recovered Asset Redemption Terms and Conditions which can be found at this link https://bafkreibjr6w7fahoj5rbe4utot3xqeffedyxxgiw4xvryw4d6n6pb6sxzq.ipfs.w3s.link'
                : `By confirming this transaction, I agree to the Metti Elastic Recovered Asset Redemption Terms which can be found at this link ${ipfsLink}`,
          },
        }),
      ])
      .then(signature => {
        ...
        {selectedNetworkToClaim ? (
          <>
            ...
            <Text color={theme.subText} fontSize={14} marginTop="24px">
              ...
              <ExternalLink href={ipfsLink}>Metti’s Terms and Conditions</ExternalLink> before proceeding. You will need
            ...
            >
              ...
              />
              <Text>
                Accept <ExternalLink href={ipfsLink}>Metti’s Terms and Conditions</ExternalLink>
              </Text>
            </TermAndCondition>
