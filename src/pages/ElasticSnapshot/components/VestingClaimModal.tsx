    ...
    library
      ?.send('eth_signTypedData_v4', [
        ...
        JSON.stringify({
          ...
          message: {
            leafIndex,
            termsAndConditions: `By confirming this transaction, I agree to the Terms and Conditions of Metti Treasury Grant Program which can be found at this link ${tcLink}`,
          },
        }),
      ])
      .then(signature => {
    ...
    <Modal width="100%" maxWidth="680px" isOpen={true} onDismiss={onDismiss}>
      ...
      >
        ...
        <Text color={theme.subText} fontSize={14} marginTop="24px">
          ...
          <ExternalLink href={tcLink}>Metti’s Terms and Conditions</ExternalLink> before proceeding. You will need to
        ...
        >
          ...
          />
          <Text>
            Accept <ExternalLink href={tcLink}>Metti’s Terms and Conditions</ExternalLink>
          </Text>
        </TermAndCondition>
