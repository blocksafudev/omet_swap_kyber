        ...
        <Container>
          <Flex flexDirection={'column'} style={{ gap: '16px' }}>
            ...
            <Disclaimer role="button" onClick={handleClickDisclaimer}>
              ...
              <span>
                <Trans>
                  You agree that Metti is using <Multichain /> to facilitate transfer of tokens between chains, and in
                  case of a security breach on Multichain, Metti won&apos;t assume any liability for any losses
                </Trans>
              </span>
            </Disclaimer>
        ...
        <Container>
          <Flex flexDirection={'column'} style={{ gap: '16px' }}>
            ...
            <Disclaimer role="button" onClick={handleClickDisclaimer}>
              ...
              <span>
                <Trans>
                  You agree that Metti is using{' '}
                  <ExternalLink href="https://www.squidrouter.com/" onClick={e => e.stopPropagation()}>
                    Squid / Axelar
                  </ExternalLink>{' '}
                  to facilitate swap of tokens between chains, and in case of a security breach on Squid / Axelar, Metti
                  won&apos;t assume any liability for any losses
                </Trans>
              </span>
            </Disclaimer>
