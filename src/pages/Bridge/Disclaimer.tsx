  ...
  return (
    <ModalCenter isOpen={show}>
      <Container>
        ...
        <TextWrapper>
          <Trans>
            Metti strives to offer its users the best DeFi experience on a single platform. In order to do that, Metti
            partners with 3rd party platforms like Multichain.
          </Trans>
        </TextWrapper>
        <TextWrapper>
          <Trans>
            ...
            our partners platform, Metti won&apos;t assume any liability for any losses incurred.
          </Trans>
        </TextWrapper>
    ...
    <ModalCenter isOpen={show}>
      <Container>
        ...
        <TextWrapper>
          <Trans>
            Metti strives to offer its users the best DeFi experience on a single platform. In order to do that, Metti
            partners with 3rd party platforms like <ExternalLink href="https://axelar.network/">Axelar</ExternalLink>{' '}
            and <ExternalLink href="https://www.squidrouter.com/">Squid</ExternalLink>.
          </Trans>
        </TextWrapper>
        <TextWrapper>
          <Trans>
            However, in the event of a security breach on our partners platform, Metti won&apos;t assume any liability
