      ...
      <WarningCard padding="10px 16px">
        <Flex alignItems="center" sx={{ gap: '12px' }} lineHeight={1.5}>
          ...
          <Text flex={1} fontSize={12}>
            <Trans>
              Disclaimer: Metti is a permissionless protocol optimized for the standard ERC20 implementation only.
              ...
              <ExternalLink
                href={
                  href ||
                  'https://docs.metti.com/liquidity-solutions/metti-elastic/user-guides/elastic-pool-creation#non-standard-tokens'
                }
              >
                here
              </ExternalLink>
