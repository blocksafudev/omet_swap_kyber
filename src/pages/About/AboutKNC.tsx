    ...
    >
      ...
      <Text color={theme.text} marginTop="24px" textAlign={above500 ? 'start' : 'center'} lineHeight={1.5}>
        <Trans>
          ...
          on Metti and other benefits from ecosystem collaborations on Kyber.
        </Trans>
      </Text>
    </ForLiquidityProviderItem>
  )
    ...
    >
      <AboutPage>
        <Wrapper>
          ...
          >
            <Trans>
              KNC is a utility and governance token and an integral part of Kyber Network and its product Metti - the
              multi-chain decentralized exchange (DEX) that provides superior rates for traders.{' '}
            </Trans>
          </Text>
          ...
          <Text color={theme.text} marginTop={['40px', '48px']} fontSize="1rem" textAlign="center" lineHeight={1.5}>
            <Trans>
              KNC token holders can benefit from our flagship product Metti. Holders can stake their KNC & vote on
              initiatives to receive trading fees generated on Metti! More trades on Metti can generate more rewards for
              KNC holders!
              <br />
              <br />
            ...
            <Flex width="100%" flexDirection="column" height="max-content">
              ...
              <Text fontSize="16px" marginTop={['40px', '48px']} color={theme.text} lineHeight="24px" textAlign="left">
                <Trans>
                  ...
                  Metti through trading activities in Kyber Network.
                </Trans>
              </Text>
              <img
                width="100%"
      ...
      <Footer background={theme.background}>
        <FooterContainer>
          <Flex flexWrap="wrap" sx={{ gap: '12px' }} justifyContent="center">
            <ExternalLink href={`https://docs.metti.com`}>
              <Trans>Docs</Trans>
            </ExternalLink>
            <VerticalDivider />
