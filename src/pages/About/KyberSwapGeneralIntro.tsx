...
const KyberSwapGeneralIntro = () => {
  ...
  const renderKyberSwapIntroDEX = () => {
    return (
      ...
      >
        <Trans>
          Metti is a decentralized exchange (DEX) aggregator. We provide our traders with <b>superior token prices</b>{' '}
          by analyzing rates across thousands of exchanges instantly!
        </Trans>
      </Text>
    )
  }
