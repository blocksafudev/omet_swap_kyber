...
const filterTags = [
  ...
  },
  {
    ...
    icon: <IconHighAprPool width={20} color="#23A66F" />,
    ...
    <PoolPageWrapper>
      ...
      <div>
        ...
        <Text color={theme.subText} marginTop="8px" fontStyle={'italic'}>
          {t`Metti: Instantly add liquidity to high-APY pools using any token(s) or your existing liquidity position with KyberZap`}
        </Text>
      </div>
      <HeadSection>
        <TagContainer>
      ...
      <Disclaimer>{t`Metti provides tools for tracking & adding liquidity to third-party Protocols. For any pool-related concerns, please contact the respective Liquidity Protocol directly.`}</Disclaimer>
    </PoolPageWrapper>
  )
}
