...
export default function JoinReferal() {
  ...
  const handleJoin = async (code: string) => {
    ...
    const message = new SiweMessage({
      ...
      address: account,
      statement: `By signing this message, you confirm your participation in the Metti Referral Program. This action does not trigger any transaction and does not incur any gas fees.`,
