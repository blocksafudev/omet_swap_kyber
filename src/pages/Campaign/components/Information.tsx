...
const howToEarnPoints = (week: number) => ({
  [CampaignType.Aggregator]: (
    <>
      <li>
        Points are earned each time a user swap eligible tokens on Metti Aggregator API. Eligible tokens are indexed in
        4 different categories, giving different amount of points per USD swapped. Eligible tokens can be found on{' '}
      ...
      <li>
        ...
        Users that perform swaps with <Link to="/">Metti.com</Link> website directly will benefit of 25% more points on
        each eligible trade.
      </li>
      <li>
        <Text as="span" color="#ffffff" fontStyle="bold">
  ...
  [CampaignType.LimitOrder]: (
    <>
      <li>
        Points are earned each time a Maker Order is filled on Metti Limit-Order. Eligible tokens are indexed in 4
  ...
  [CampaignType.Referrals]: (
    <span>
      ...
      only trades made on <Link to="/">Metti.com</Link> are eligible, trades on other platforms are not eligible for
...
const faq = {
  [CampaignType.Aggregator]: [
    {
      ...
      a: (
        <span>
          ...
          <Link to="/">metti.com</Link> and other interfaces that support our Aggregator. To name a few: Defillama,
    ...
    },
    {
      ...
      a: (
        <span>
          ...
          <Link to="/campaigns/dashboard">metti.com/campaigns/dashboard.</Link>
        </span>
      ),
    },
    {
  ...
  [CampaignType.LimitOrder]: [
    {
      ...
      a: (
        <span>
          ...
          <Link to="/limit/arbitrum">https://metti.com/limit/arbitrum.</Link> Only filled orders will give you points.
        </span>
      ),
    },
    {
    ...
    },
    {
      ...
      a: (
        <span>
          ...
          <Link to="/campaigns/dashboard?tab=limit-order-farming">metti.com/campaigns/dashboard.</Link>
        </span>
      ),
    },
    {
  ...
  [CampaignType.Referrals]: [
    ...
    },
    {
      ...
      a: (
        <>
          <li>As a referee, you&apos;ll get a 5% bonus on your rewards from metti.com.</li>
          <li>
            As a referrer, when someone you referred earns ARB on a trade made on metti.com, you get 10% of their
            rewards allocation.
          </li>
          <b>Example:</b>
          <ul style={{ marginTop: '0' }}>
            <li>1. John refers Vitalik.</li>
            <li>2. At the end of the week, Vitalik earns 10 ARB from trading on metti.com.</li>
          ...
          <li>
            <span style={{ color: '#ffffff' }}>Note</span>: The referral bonus applies only on trades made on metti.com
            within the Aggregator Trading Campaign.
          </li>
        </>
      ),
    },
    {
      ...
      a: (
        <span>
          Trades made on <Link to="/swap/arbitrum">https://metti.com/swap/arbitrum</Link> which created the rewards from
          Trading campaign will be eligible for referrals bonus
        </span>
      ),
    },
    {
...
export default function Information({ type, week }: { type: CampaignType; week: number }) {
  ...
  return (
    ...
    >
      ...
      >
        <li>
          These Terms and Conditions <ExternalLink href="https://metti.com/metti.pdf">({'"Terms"'})</ExternalLink>{' '}
          should be read in conjunction with the Metti Terms of Use, which lay out the terms and conditions that apply
          to all Metti promotional activities ({'"Campaign"'}).
        </li>
        <li>
        ...
        {week > 28 && (
          <>
            ...
            <li>
              ...
              Metti team can exclude wallets from the campaign at its sole discretion.
            </li>
            {type === CampaignType.Aggregator && (
              <li>Only trades made through whitelisted router contracts such as Metti Router are eligible.</li>
            )}
          </>
        )}
      </Text>
