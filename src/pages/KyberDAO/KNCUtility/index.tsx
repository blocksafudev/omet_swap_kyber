            ...
            <Column gap="16px">
              ...
              <Text as="span" fontSize={16} fontWeight={500} color={theme.subText} lineHeight="24px">
                <Trans>
                  ...
                  <NavLink to={APP_PATHS.KYBERDAO_VOTE}>vote on KIPs</NavLink> and shape the future of the Metti
        ...
        <Row style={{ padding: upToMedium ? '16px 0 12px' : undefined }}>
          ...
          <Column gap="16px">
            ...
            <Text fontSize={16} fontWeight={400} lineHeight="24px" color={theme.subText}>
              <Trans>
                To participate in Metti&apos;s Gas Refund Program, you must first stake KNC and then meet the necessary
                trading requirements:
              </Trans>
            </Text>
            <Text fontSize={16} fontWeight={400} lineHeight="24px" color={theme.text} fontStyle="italic">
              <Trans>
                Step 1 - Stake MET on Metti Stake
                <br />
                Step 2 - Trade on Metti
              </Trans>
            </Text>
            <ul
              style={{
            ...
            >
              <Li>
                <Text fontSize={16} fontWeight={400} lineHeight="24px" color={theme.subText} as="span">
                  <Trans>Value of each trade (calculated at the point of the trade) on Metti has to be ≥ $200.</Trans>
                </Text>
              </Li>
              <Li>
                <Text fontSize={16} fontWeight={400} lineHeight="24px" color={theme.subText} as="span">
              ...
              <Li>
                <Text fontSize={16} fontWeight={400} lineHeight="24px" color={theme.subText} as="span">
                  <Trans>
                    ...
                    <ExternalLink href="https://docs.metti.com/governance/knc-token/gas-refund-program">
                      here ↗
                    </ExternalLink>
                  </Trans>
                </Text>
              ...
              <ul style={{ paddingInlineStart: '20px', marginBlockStart: 0 }}>
                <li>
                  <Text fontSize={14} fontWeight={400} lineHeight="20px">
                    <Trans>
                      These Terms and Conditions should be read in conjunction with the Metti{' '}
                      <ExternalLink href={TERM_FILES_PATH.KYBERSWAP_TERMS}>Terms of Use</ExternalLink>, which lay out
                      the terms and conditions that apply to all Metti activities.
                    </Trans>
                  </Text>
                </li>
                <br />
                <li>
                  <Text fontSize={14} fontWeight={400} lineHeight="20px">
                    <Trans>
                      By visiting Metti and participating in the program, the User is deemed to have read, understood,
                      and agreed to these Terms and Conditions and the Metti{' '}
                ...
                <li>
                  <Text fontSize={14} fontWeight={400} lineHeight="20px">
                    <Trans>
                      For this pilot gas refund program, Metti retains the right to cancel or amend the program&apos;s
                ...
                <li>
                  <Text fontSize={14} fontWeight={400} lineHeight="20px">
                    <Trans>
                      Metti maintains the right, at its sole discretion, to take action or remove rewards against the
                      User who violates the Metti{' '}
                ...
                <li>
                  <Text fontSize={14} fontWeight={400} lineHeight="20px">
                    <Trans>
                      Any and all decisions made by Metti in relation to every aspect of the program shall be final and
                      conclusive.
                    </Trans>
                  </Text>
                </li>
