  ...
  return (
    <DetailsContainer>
      <DetailPanel
        ...
        content={
          <Trans>
            ...
            swap(s) on Metti, with a minimum trading volume of ≥$200 per swap.
          </Trans>
        }
      />
      <Separator />
      ...
      <DetailPanel
        ...
        content={
          <Trans>
            No. Limit orders and cross-chain swaps are not eligible for gas refunds. Only standard swaps on Metti are
            eligible.
          </Trans>
        }
      />
      ...
      <DetailPanel
        ...
        content={
          <Trans>
            ...
            visit{' '}
            <ExternalLink href="https://docs.metti.com/governance/kyberdao">
              https://docs.metti.com/governance/kyberdao
            </ExternalLink>
            .
          </Trans>
        }
