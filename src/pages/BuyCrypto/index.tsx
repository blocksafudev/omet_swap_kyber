              ...
              <Flex flexDirection="column" marginLeft={!upToMedium ? '48px' : 0} data-aos="fade-left" flex={1}>
                ...
                <Text color={theme.subText} lineHeight={1.5} marginTop={upToMedium ? '40px' : '48px'}>
                  <Trans>
                    ...
                    blockchain applications like Metti. You can buy, store, send and swap tokens using this wallet.
                    <br />
                    <br />
                    On Metti we support a list of wallets including: MetaMask, Coin98, Wallet Connect, Coinbase Wallet,
                    Ledger and others.
                  </Trans>
                </Text>
            ...
            >
              <Flex flexDirection="column" flex={1}>
                ...
                <Text color={'#A7B6BD'} lineHeight={1.5} marginTop={upToMedium ? '40px' : '48px'}>
                  ...
                  an independent party over which Metti has no control (&quot;
