...
export const DOCS_LINKS = {
  GASLESS_CANCEL: 'https://docs.metti.com/kyberswap-solutions/limit-order/concepts/gasless-cancellation#gasless-cancel',
  HARD_CANCEL: 'https://docs.metti.com/kyberswap-solutions/limit-order/concepts/gasless-cancellation#hard-cancel',
  CANCEL_GUIDE: 'https://docs.metti.com/kyberswap-solutions/limit-order/user-guides/cancel-limit-orders',
  USER_GUIDE: 'https://docs.metti.com/kyberswap-solutions/limit-order',
}
