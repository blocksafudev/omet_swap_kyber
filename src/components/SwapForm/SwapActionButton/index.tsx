  ...
  const approveTooltipText = () => {
    ...
    return (
      <Trans>
        ...
        <a
          href="https://docs.metti.com/kyberswap-solutions/kyberswap-interface/user-guides/instantly-swap-at-superior-rates#step-4-approve-contract-to-swap-tokens"
          target="_blank"
          rel="noreferrer"
        >
          Read more ↗
                  ...
                  <InfoHelper
                    ...
                    text={
                      <Trans>
                        ...
                        <a href="https://docs.metti.com/reference/permitable-tokens" target="_blank" rel="noreferrer">
                          Read more ↗
                        </a>
                      </Trans>
                    }
