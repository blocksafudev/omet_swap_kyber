...
function Welcome() {
  return (
    <Layout>
      <img src={WelcomeImage} alt="welcome to metti" style={{ maxWidth: '100%', marginTop: 10 }} />
      <Desc>
        <Trans>
          Metti is a decentralized exchange (DEX) aggregator and an automated market maker (AMM). We provide our traders
          with the <HighlightText>superior token prices</HighlightText> by analyzing rates across hundreds of exchanges
      ...
      <Desc>
        <Trans>
          Metti also allows users to <HighlightText>trade smarter</HighlightText>. We provide various trading insights
          so our users can get access to <HighlightText>alpha</HighlightText> instantly!
        </Trans>
      </Desc>

      <Desc>
        <Trans>Here&apos;s a quick tutorial guide about Metti&apos;s main features. Do you wish to have a look?</Trans>
      </Desc>
    </Layout>
  )
}
...
function ConnectWallet() {
  ...
  return (
    <Layout title={LIST_TITLE.CONNECT_WALLET}>
      <Desc>
        <Trans>Choose your preferred wallet, connect it, and get started with Metti!</Trans>
      </Desc>
...
function SwapForm() {
  ...
  return (
    <Layout title={LIST_TITLE.START_TRADING}>
      <Desc>
        <Trans>
          Select from over thousands of tokens and start trading. Metti finds you superior prices across multiple
    ...
    },
    {
      ...
      description: (
        <Layout title={LIST_TITLE.SELECT_NETWORK}>
          <Desc>
            <Trans>Choose your preferred network. Metti is a multi-chain platform that supports over 13 chains!</Trans>
          </Desc>
        ...
        <Layout title={LIST_TITLE.VIEW_GUIDE}>
          ...
          <Desc>
            <Trans>
              ...
              <ExternalLink href="https://docs.metti.com/guides/getting-started">click here.</ExternalLink>
            </Trans>
          </Desc>
