  ...
  const subTitle = (() => {
    switch (type) {
      case TutorialType.CLASSIC_ADD_LIQUIDITY:
        return (
          <Trans>
            To learn more about how to add liquidity to Metti Classic, view{' '}
            <ExternalLink href="https://docs.metti.com/Classic/guides/adding-liquidity-guide"> here</ExternalLink>
          </Trans>
        )
      ...
      case TutorialType.ELASTIC_ADD_LIQUIDITY:
        return (
          <Trans>
            To learn more about how to add liquidity to Metti Elastic, view{' '}
            <ExternalLink href="https://docs.metti.com/guides/creating-a-pool"> here</ExternalLink>
          </Trans>
        )
      ...
      case TutorialType.ELASTIC_INCREASE_LIQUIDITY:
        return (
          <Trans>
            To learn more about how to increase liquidity to Metti Elastic, view{' '}
            <ExternalLink href="https://docs.metti.com/guides/increase-liquidity"> here</ExternalLink>
          </Trans>
        )
      ...
      case TutorialType.ELASTIC_REMOVE_LIQUIDITY:
        return (
          <Trans>
            To learn more about how to remove liquidity on Metti Elastic, view{' '}
            <ExternalLink href="https://docs.metti.com/guides/remove-liquidity"> here</ExternalLink>
          </Trans>
        )
